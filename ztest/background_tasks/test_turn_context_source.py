...
from mote.orchestration.background_tasks import BackgroundTaskContextSource, BackgroundTaskStatus, TaskSnapshot
...
class TestBackgroundTaskContextSource:
    ...
    def test_lazy_pool_appears_later(self):
        ...
        meta = TaskSnapshot(task_id="bg_2", command_name="later", status=BackgroundTaskStatus.RUNNING)
