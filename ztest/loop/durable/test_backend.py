#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Tests for ``mote.loop.durable.backend`` — the Tier-1 JSONL durable backend.
...
from mote.common.ledger import COMPLETED, FAILED, KIND_THINK, STARTED, RunJournal
from mote.common.workspace import WorkspaceStore
from mote.loop.durable import DurableBackend, JsonlBackend
