"""Tests for :mod:`mote.orchestration.workflows.base_node`."""
...
async def test_runtime_type_mismatch_raises():
    ...
    g = WorkflowBuilder("test", state_schema=StrState)
    ...
    from mote.orchestration.workflows.engine import _validate_node_params_runtime
