...
from mote.runtime.file_paths import path_to_uri, uri_to_path
from mote.runtime.lsp.jsonrpc import JsonRpcEndpoint
from mote.runtime.lsp.registry import DiagnosticRegistry, parse_diagnostic
...
class LspServerInstance:
    ...
    async def did_save(self, path: str) -> None:
        ...
        self._endpoint.notify(
            ...
            {"textDocument": {"uri": uri}, "text": self._read_text(path) or ""},
        )
