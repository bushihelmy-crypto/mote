"""Deterministic in-process Canvas backend for tests and headless rendering."""
from __future__ import annotations

import asyncio

from mote.contracts.canvas import CanvasDocument, CanvasExportRepresentation, CanvasOperation
from mote.contracts.ports.canvas_backend import CanvasBackendCapabilities, CanvasBackendRender
from mote.runtime.tools.dependency.canvas_state import apply_canvas_operations
