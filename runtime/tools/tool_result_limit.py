...
Disk writes go through :mod:`mote.runtime.disk.disk_io` so this shares the exact
...
exclusively through :class:`mote.runtime.workspace.WorkspaceStore`, so a
...
from mote.contracts.schema import (
    DEFAULT_MAX_RESULT_SIZE_CHARS,
    PERSISTED_OUTPUT_CLOSE_TAG,
    PERSISTED_OUTPUT_OPEN_TAG,
    PREVIEW_SIZE_BYTES,
)
from mote.contracts.text import cap_head, format_file_size
