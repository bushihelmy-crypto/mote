"""Extension to provider registry for Code Map language dispatch.

This is the language-agnostic lookup the extractor facade and the indexer route
through: which :class:`~mote.runtime.code_map.providers.base.LanguageProvider`
(if any) owns a given file, and the full set of extensions worth walking. The
registry is built once from :func:`~mote.runtime.code_map.providers.all_providers`
...
from mote.runtime.code_map.providers import all_providers
from mote.runtime.code_map.providers.base import LanguageProvider
