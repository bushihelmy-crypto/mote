"""TreeSitterBuilder — the config-driven walk from a tree-sitter tree to the
neutral :class:`~mote.runtime.code_map.scopes.ScopeGraph` + presentation symbols.

This is the tree-sitter twin of the Python ``ast`` walk
(:class:`~mote.runtime.code_map.providers.python._ScopeGraphBuilder`): given a
:class:`~mote.runtime.code_map.providers.config.LangConfig` (pure data — which
...
from mote.runtime.code_map.model import SUMMARY_MAX_CHARS, Symbol
from mote.runtime.code_map.providers.config import DefRule, DocRule, LangConfig
