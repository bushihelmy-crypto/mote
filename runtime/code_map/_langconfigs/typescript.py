"""TypeScript and TSX configs — JavaScript plus type-level declarations.

TypeScript is JavaScript with a type layer, so these configs reuse the JS import
extractor (:func:`~mote.runtime.code_map._langconfigs.javascript.js_esm` — ``import
...
from mote.runtime.code_map._langconfigs.javascript import js_esm
