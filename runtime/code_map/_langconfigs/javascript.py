"""JavaScript language config — declarative data + the ES-module import reader.
...
from mote.runtime.code_map._langconfigs._shared import is_relative_spec, iter_nodes, resolve_relative_stem, string_text
