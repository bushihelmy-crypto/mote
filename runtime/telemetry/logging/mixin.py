...
with :func:`~mote.runtime.telemetry.logging.decorator.log_call`. It uses
...
from mote.runtime.telemetry.logging.decorator import _LOGGED_MARKER, log_call
...
@overload
def log_class(_cls: ClassT, /) -> ClassT:
    ...
