...
patcher imports :mod:`mote.runtime.telemetry.logging.context` lazily so this module never
...
from mote.runtime.telemetry.logging.context import current_trace_id
...
def bind_session_logfile(session_id: str, log_dir: Path, level: str = "DEBUG") -> Optional[int]:
