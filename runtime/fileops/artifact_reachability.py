...
class ExternalArtifactRootSource(Protocol):
    ...
    def scan_blob_roots(self) -> tuple[BlobRef, ...]:
        ...
...
class ArtifactReachabilityProjector:
    ...
    def close(self, roots: Iterable[ArtifactRoot]) -> tuple[BlobRef, ...]:
        closed: dict[str, BlobRef] = {}
    ...
    def read_manifest_root(self, manifest: BlobRef) -> ArtifactRoot:
        return ArtifactRoot(manifest, ArtifactRootKind.READ_MANIFEST)

    def search_result_root(self, manifest: BlobRef) -> ArtifactRoot:
    ...
    @staticmethod
    def _add_mutation(closed: dict[str, BlobRef], mutation: Any) -> None:
    ...
    @staticmethod
    def _add_snapshot(closed: dict[str, BlobRef], snapshot: FileSnapshot) -> None:
    ...
    @staticmethod
    def _add(closed: dict[str, BlobRef], artifact: BlobRef) -> None:
