...
- :class:`~mote.runtime.context.code_map.extractor.CodeMapExtractor` — ``ast``-derived
  symbols + import/call edges for one Python file, with an mtime freshness cache;
- :class:`~mote.runtime.context.code_map.store.CodeMapStore` — a tiny SQLite nodes /
...
:class:`~mote.runtime.context.code_map.providers.base.ModuleResolver` (chosen by
...
from mote.contracts.text import uri_to_path
from mote.runtime.context.code_map.extractor import CodeMapExtractor
from mote.runtime.context.code_map.languages import all_registered_providers, provider_for
from mote.runtime.context.code_map.model import CallEdge, FileExtract, Symbol
from mote.runtime.context.code_map.providers.base import ModuleResolver
from mote.runtime.context.code_map.scopes import Def
