...
Where :class:`~mote.runtime.context.code_map.CodeMap` is *locality-scoped* (it only ever
...
:func:`~mote.runtime.context.code_map.paths.codemap_db_path`) so a warm start skips the
...
from mote.runtime.context.code_map.model import Symbol
from mote.runtime.context.code_map.paths import codemap_db_path
