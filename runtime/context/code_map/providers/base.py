"""Language-provider seam — the two protocols every language plugs in through.
...
:class:`~mote.runtime.context.code_map.model` rows + a resolved
:class:`~mote.runtime.context.code_map.scopes.ScopeGraph`, and one :class:`ModuleResolver`
...
from mote.runtime.context.code_map.model import ImportBinding, ImportRef, Symbol
...
class ProviderExtract:
    ...
    The facade wraps this into a :class:`~mote.runtime.context.code_map.model.FileExtract`,
