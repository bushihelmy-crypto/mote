...
thread-local parser from :mod:`~mote.runtime.context.code_map.ts_runtime`, runs a fresh
:class:`~mote.runtime.context.code_map.generic_builder.TreeSitterBuilder` over the tree,
...
from mote.runtime.context.code_map.generic_builder import TreeSitterBuilder, module_summary
from mote.runtime.context.code_map.providers.base import ModuleResolver, ProviderExtract
