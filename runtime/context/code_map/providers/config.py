"""Declarative language config — the data a tree-sitter language contributes.
...
imports and answer module⇄file questions. :class:`~mote.runtime.context.code_map.generic_builder.TreeSitterBuilder`
reads exactly this to emit the same neutral
:class:`~mote.runtime.context.code_map.scopes.ScopeGraph` + :class:`~mote.runtime.context.code_map.model.Symbol`
...
class DefRule:
    ...
    ``def_kind`` is the neutral :class:`~mote.runtime.context.code_map.scopes.Def` kind
...
__all__ = ["DocRule", "DefRule", "FieldAccess", "LangConfig", "ImportExtractor", "NameExtractor"]
