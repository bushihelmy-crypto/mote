"""Neutral extract data model — the language-independent shape every provider fills.
...
Split out of :mod:`~mote.runtime.context.code_map.extractor` so the multi-language
provider seam (:mod:`~mote.runtime.context.code_map.providers`) and the store can share
...
__all__ = ["Symbol", "CallEdge", "ImportRef", "ImportBinding", "FileExtract", "SUMMARY_MAX_CHARS"]
