...
class ReductionOutcome:
    ...
    # Set by the summarize reducer on a successful summarization. Other successful
    # strategies still publish the rebuilt model-context projection with no summary.
