...
import mote.runtime.context.budget as budget
from mote.contracts.constants.messages import CACHE_INTENT, CACHE_INTENT_EPHEMERAL_TAIL
from mote.contracts.schema import ContextManagerConfig, FoldState, LLMCallContext
from mote.contracts.text import is_system_reminder
...
if TYPE_CHECKING:
    ...
    from mote.contracts.schema.messages import Message, UserMessage
else:
    from mote.contracts.schema import Message, UserMessage

from mote.runtime.context.budget import TokenAccountant
...
class ContextManager:
    ...
    def rebuild_compression(
        ...
        *,
        ...
        config: ContextManagerConfig | None = _UNSET,
    ) -> None:
