...
- ``python -m mote.runtime.config.report`` — the CLI entry point.
"""
...
from mote.runtime.config.diagnostics import _get_path, _render_value, unknown_key_paths
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m mote.runtime.config.report",
