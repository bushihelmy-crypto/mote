...
The Jupyter :class:`~mote.runtime.interactive.kernel.driver.KernelSession` and the PTY
:class:`~mote.runtime.interactive.terminal.driver.TerminalSession` both snapshot a
