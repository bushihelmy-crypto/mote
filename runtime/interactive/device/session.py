...
Mirrors :class:`mote.runtime.interactive.browser.session.BrowserSession`'s lifecycle
...
from mote.runtime.interactive.device.outline import Snapshot, build_snapshot, render_snapshot
