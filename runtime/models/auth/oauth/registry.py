...
``mote.contracts.config.oauth`` so the config validator can apply
...
from mote.contracts.config.oauth import PROVIDER_PRESETS, apply_preset, get_preset, list_presets
