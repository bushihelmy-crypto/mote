"""Crash-safe local audit store for model endpoint operator controls."""
...
from mote.contracts.models.failover import OperatorTransition
...
def default_model_operator_audit_path() -> Path:
    return Path(DEFAULT_WORKSPACE_ROOT) / ".runtime" / MODEL_OPERATOR_AUDIT_FILENAME
...
__all__ = [
    ...
    "default_model_operator_audit_path",
]
