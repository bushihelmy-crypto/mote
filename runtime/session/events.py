...
SESSION_EVENT_CLASSES = MappingProxyType(
    {
        ...
        INFERENCE_CHECKPOINT_CONSUMED: InferenceCheckpointConsumedEvent,
        ...
        FINAL_OUTPUT_COMMITTED: FinalOutputCommittedEvent,
        PENDING_ACT_SCHEMA_ACTIVATED: PendingActSchemaActivatedEvent,
        PENDING_ACT_CREATED: PendingActCreatedEvent,
        PENDING_ACTION_ARGUMENTS_REVISED: PendingActionArgumentsRevisedEvent,
        APPROVAL_REQUESTED: ApprovalRequestedEvent,
        APPROVAL_DECISION_COMMITTED: ApprovalDecisionCommittedEvent,
        "session.permission_rule.granted.v1": SessionPermissionRuleGrantedEvent,
        EXTERNAL_EFFECT_STARTED: ExternalEffectStartedEvent,
        EXTERNAL_EFFECT_FINISHED: ExternalEffectFinishedEvent,
        EXTERNAL_EFFECT_IN_DOUBT: ExternalEffectInDoubtEvent,
        PENDING_ACT_SETTLED: PendingActSettledEvent,
        PENDING_ACTION_RESULT_COMMITTED: PendingActionResultCommittedEvent,
        PENDING_ACTIONS_SKIPPED: PendingActionsSkippedEvent,
        RUN_RECOVERY_CURSOR_ADVANCED: RunRecoveryCursorAdvancedEvent,
        TURN_INTERRUPTED: TurnInterruptedEvent,
        TURN_INTERRUPTED_CONTEXT_ATTACHED: TurnInterruptedContextAttachedEvent,
        TURN_INTERRUPT_SETTLED: TurnInterruptSettledEvent,
        PENDING_ACT_INTERRUPTED: PendingActInterruptedEvent,
        PENDING_ACT_CLAIM_ACQUIRED: PendingActClaimAcquiredEvent,
        PENDING_ACT_CLAIM_RENEWED: PendingActClaimRenewedEvent,
        PENDING_ACT_CLAIM_TAKEN_OVER: PendingActClaimTakenOverEvent,
        PENDING_ACT_CLAIM_RELEASED: PendingActClaimReleasedEvent,
