"""Product policy for persistent Code Map store locations.
...
def codemap_db_path(project_root: str, *, codemap_root: Path) -> str:
    ...
    repo_dir = os.path.join(str(codemap_root), digest)
