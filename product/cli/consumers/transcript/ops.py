...
A :class:`~mote.product.cli.consumers.transcript.reducer.TranscriptReducer` folds the
...
:class:`~mote.product.cli.consumers.transcript.surface.RenderSurface` — one method per
...
@dataclass(frozen=True)
class RenderArtifact(_RenderEvent):
...
@dataclass(frozen=True)
class UpdateRuntimeDurability(_RenderEvent):
