...
implementing a :class:`~mote.product.cli.consumers.transcript.surface.RenderSurface`.
...
from mote.product.cli.consumers.render.builders import FoldMode, fold_mode
...
class TranscriptReducer:
    ...
    def _fold(self, ev: Any, kind: Any) -> List[TranscriptOp]:
        ...
        if kind == RUNTIME_DURABILITY_STATUS:
