...
Itself a :class:`~mote.product.cli.contracts.base.consumer.BaseConsumer`, so a host wires
...
from mote.product.cli.consumers.transcript.surface import RenderSurface
