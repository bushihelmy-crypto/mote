...
One method per :class:`~mote.product.cli.consumers.transcript.ops.TranscriptOp`, named
exactly like the op's ``kind`` so the
:class:`~mote.product.cli.consumers.transcript.driver.SurfaceDriver` dispatches with a
...
from mote.product.cli.consumers.transcript.ops import Truncation
