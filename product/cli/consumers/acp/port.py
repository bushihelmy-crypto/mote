...
from mote.product.cli.view.approval import approval_action, approval_preview, approval_risk
...
class AcpPort:
    ...
    Implements the
    :class:`~mote.product.cli.contracts.interface.ports.InputPort` protocol structurally
    ...
    async def decide_approval(self, ctx: Any, request: Any) -> "ApprovalDecision":
        ...
        + the four standard :func:`~mote.product.cli.consumers._wire.acp.permission_options`)
        ...
        :data:`~mote.product.cli.consumers._wire.acp.PERM_KIND_TO_OUTCOME`; a ``cancelled``
