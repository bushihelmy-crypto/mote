...
from mote.product.cli.consumers.acp.consumer import AcpConsumer
from mote.product.cli.consumers.acp.port import DEFAULT_PERMISSION_TIMEOUT_S, AcpPort
from mote.product.cli.serving import ConnectionScope, SessionRegistry
from mote.runtime.agent.lsp.jsonrpc import _rpc_error
...
class AcpServer:
    ...
    async def _on_session_fork(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        forked = await backend.fork_role(source.role)
        if forked is None:
