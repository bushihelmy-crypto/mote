...
:class:`~mote.product.cli.consumers.terminal.consumer.TerminalConsumer` and the
full-screen :class:`~mote.product.cli.consumers.textual.app.MoteApp` (and, in future,
