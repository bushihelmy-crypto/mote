...
The :class:`~mote.product.cli.consumers.terminal.consumer.TerminalConsumer` used to
...
``from mote.product.cli.consumers.render.builders import X`` keeps resolving for all
existing call sites:
...
from mote.product.cli.consumers.render.builders._rich import _HAS_RICH  # noqa: F401  # facade re-export
...
from mote.product.cli.consumers.render.builders.diff import render_diff, render_file_change
from mote.product.cli.consumers.render.builders.effects import interpolate_color, shimmer_text, sparkline
from mote.product.cli.consumers.render.builders.image import IMAGE_MAX_COLS, IMAGE_MAX_ROWS, render_image
