...
from mote.product.cli.consumers.render.theme import MARKDOWN_THEME
...
# :mod:`mote.product.cli.consumers.render.mathbox`, split by *dimensionality*:
#
...
class MathBlock(MarkdownElement):
    ...
    box engine (:func:`~mote.product.cli.consumers.render.mathbox.build_box`) which returns
