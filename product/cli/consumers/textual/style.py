...
:class:`~mote.product.cli.consumers.render.palette.Palette` (hex tokens) into Textual's
``$variable`` map, which :class:`~mote.product.cli.consumers.textual.app.MoteApp`
...
from mote.product.cli.consumers.render.palette import (  # re-export the shared figure set
    BRANCH,
    BULLET,
    CHECK,
    COMPACT,
