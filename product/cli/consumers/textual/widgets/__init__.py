...
every symbol here as a facade, so ``from mote.product.cli.consumers.textual.widgets
...
``mote.product.cli.consumers.render.builders`` so the terminal and Textual hosts never
diverge on look (§9.7 "format once").
"""

from __future__ import annotations

from mote.product.cli.consumers.textual.widgets.activity import ActivityWidget
from mote.product.cli.consumers.textual.widgets.base import SelectableStatic
from mote.product.cli.consumers.textual.widgets.prompt_input import PROMPT_SYMBOL, PromptInput
from mote.product.cli.consumers.textual.widgets.status_bar import (  # noqa: F401  # re-export for tests
    StatusBar,
    _format_tok,
)
from mote.product.cli.consumers.textual.widgets.transcript import (
    ApprovalMarkerRow,
    AssistantBlock,
