...
Modelled on :class:`~mote.product.cli.consumers.textual.widgets.transcript.ToolGroupWidget`:
...
from mote.product.cli.consumers.render.builders import activity_header, activity_outcome, activity_topology
from mote.product.cli.consumers.textual.style import BRANCH, Palette
from mote.product.cli.consumers.textual.widgets.transcript import FoldableRow, build_tool_parts
