#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""``mote.product.cli.consumers.textual`` — the full-screen Textual TUI host.
...
(:class:`~mote.product.cli.contracts.interface.ports.InteractivePort`) — so the
...
# so ``import mote.product.cli.consumers.textual`` is safe without ``textual`` present.
_LAZY = {
    "run_textual": ("mote.product.cli.consumers.textual.bootstrap", "run_textual"),
    "MoteApp": ("mote.product.cli.consumers.textual.app", "MoteApp"),
    "ViewEventMessage": ("mote.product.cli.consumers.textual.app", "ViewEventMessage"),
    "TextualConsumer": ("mote.product.cli.consumers.textual.consumer", "TextualConsumer"),
}
