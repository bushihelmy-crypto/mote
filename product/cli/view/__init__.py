...
:class:`~mote.product.cli.view.projector.ViewProjector`. The human *contract* it folds
into (``ViewEvent`` + the capability downgrade rules) is shared across hosts and
lives in :mod:`mote.product.cli.contracts.view`; the reusable fan-out plumbing
...
keep importing ``from mote.product.cli.view import ...``.
"""
