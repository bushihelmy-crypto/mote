#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""``mote.product.presentation.state`` — the shared event-orchestration state machine.
...
from mote.product.presentation.state.driver import SurfaceDriver, apply_ops
...
from mote.product.presentation.state.surface import BaseSurface, RenderSurface
