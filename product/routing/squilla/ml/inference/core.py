#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Phase-3 inference orchestrator — vendored verbatim from opensquilla.

Source: ``squilla_router/models/.../runtime_src/src/router/inference/core.py``.

``InferenceCore.from_model_dir`` loads the artifacts; ``predict`` runs the full
build_features → run_heads → fuse → postprocess pipeline.
"""
from __future__ import annotations

import numpy as np

from mote.product.routing.squilla.ml.inference.artifacts import InferenceArtifacts
from mote.product.routing.squilla.ml.inference.ensemble import fuse_probabilities
from mote.product.routing.squilla.ml.inference.features import build_feature_bundle
from mote.product.routing.squilla.ml.inference.heads import run_heads
