#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Phase-3 390-dim online feature assembly — vendored verbatim from opensquilla.

Source: ``squilla_router/models/.../runtime_src/src/router/inference/features.py``.

390 = concat([hc(51), tfidf(102), ctx(10), hist(16), pca_192(BGE 3×64),
              asst(12), cont(2), reasoning(5)]).
"""
from __future__ import annotations

import numpy as np

from mote.product.routing.squilla.ml.inference.types import FeatureBundle, InferenceRequest
from mote.product.routing.squilla.ml.v4_features import (
