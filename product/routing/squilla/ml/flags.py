#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Rule-based routing flag computation — vendored verbatim from opensquilla.

Source: ``squilla_router/models/.../runtime_src/src/router/flags.py``.
...
the public ergonomic wrapper lives in ``mote.product.routing.squilla.flags``.
"""
