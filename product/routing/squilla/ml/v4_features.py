#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""V4 router feature extraction helpers — vendored from opensquilla.

Source: ``squilla_router/models/.../runtime_src/src/router/v4_features.py``.
...
Phase 3's 390-dim online assembly lives in ``mote.product.routing.squilla.ml.inference.features``.
...
from mote.product.routing.squilla.ml.bge_onnx import OnnxBGE
