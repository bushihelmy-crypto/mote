...
:mod:`mote.product.presentation.rich_rendering.palette` (shared by every host). This module
...
:class:`~mote.product.interfaces.terminal.port.TerminalPort` writes directly to a plain
...
from mote.product.presentation.rich_rendering.palette import BULLET, PROMPT_SYMBOL
