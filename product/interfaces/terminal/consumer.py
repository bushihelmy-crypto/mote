...
:class:`~mote.product.presentation.state.reducer.TranscriptReducer` (the single
event-orchestration state machine, shared with the Textual app) and the
:class:`~mote.product.interfaces.terminal.surface.TerminalSurface` (the rich
...
:class:`~mote.product.presentation.state.driver.SurfaceDriver`, itself an ordinary
...
from mote.product.presentation.rich_rendering.palette import COMPACT, NOTE

try:
    from mote.product.interfaces.terminal.rich_adapter import build_rich_terminal_consumer
