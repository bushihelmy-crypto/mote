...
:class:`~mote.product.interfaces.textual.port.TextualPort` pushes one of these
...
* :class:`ApprovalScreen` — a gated-action permission round-trip; dismisses with an
  :class:`~mote.product.presentation.events.events.ApprovalDecision` (``y/n/a/d`` keys or
...
from mote.product.interfaces.textual.style import PROMPT_SYMBOL, WARN
from mote.product.presentation.events.events import ApprovalDecision
from mote.product.presentation.projection.approval import (
    approval_action,
    approval_options,
    approval_preview,
    approval_risk,
