...
SHARED ``mote.product.presentation.rich_rendering.builders`` — the exact same diff colours,
...
from mote.product.interfaces.textual.style import BULLET, NOTE, WARN, Palette
