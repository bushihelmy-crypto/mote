...
into AG-UI wire events (via the pure :mod:`mote.product.interfaces.agui.wire` mapper)
...
from mote.product.interfaces.agui.consumer import AguiConsumer, build_agui_consumer
