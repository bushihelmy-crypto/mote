...
from mote.contracts.ports import ModelGateway, ModelRoute
...
from mote.kernel.models.model_calls import web_search as search_with_model
from mote.product.toolsets.builtin.web_search_registry import SearchBackendRegistry
