#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Routing trajectory classification — vendored verbatim from opensquilla.

Source: ``squilla_router/models/.../runtime_src/src/router/trajectory.py``.
Classifies a sequence of per-turn :class:`TurnDecision` records into a coarse
trajectory label used by the history feature channel.
"""
