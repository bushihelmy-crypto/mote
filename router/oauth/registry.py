...
``mote.common.config.config.oauth_config`` so the config validator can apply
...
dependency direction), keeping ``mote.router.oauth.registry`` import paths
stable for existing callers and tests.
"""
from __future__ import annotations

from mote.common.config.config.oauth_config import PROVIDER_PRESETS, apply_preset, get_preset, list_presets
