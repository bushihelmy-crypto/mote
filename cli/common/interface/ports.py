...
if TYPE_CHECKING:  # avoid a runtime import cycle (view.events → common) — types only
    from metagpt.common.schema import AskUserQuestionAnswers, AskUserQuestionInput
    from metagpt.cli.common.view.events import ApprovalDecision, ApprovalRequested
