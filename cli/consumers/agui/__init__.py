...
into AG-UI wire events (via the pure :mod:`mote.cli.consumers._wire.agui` mapper)
...
from mote.cli.consumers.agui.consumer import AguiConsumer, build_agui_consumer
