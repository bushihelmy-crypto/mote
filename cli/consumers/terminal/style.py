...
:mod:`mote.cli.consumers.render.palette` (shared by every host). This module
...
:class:`~mote.cli.io.terminal_io.TerminalPort` writes directly to a plain
...
from mote.cli.consumers.render.palette import BULLET, PROMPT_SYMBOL
