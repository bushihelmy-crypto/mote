...
:mod:`metagpt.cli.consumers.render.palette` (shared by every host). This module
...
:class:`~metagpt.cli.io.terminal_io.TerminalPort` writes directly to a plain
...
from metagpt.cli.consumers.render.palette import BULLET, PROMPT_SYMBOL
...
def render_banner() -> str:
    ...
    """
    title = ansi_fg(f"{BULLET} MetaGPT CLI", bold=True)
