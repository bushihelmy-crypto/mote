...
Modelled on :class:`~mote.cli.consumers.textual.widgets.transcript.ToolGroupWidget`:
...
from mote.cli.consumers.render.builders import activity_header, activity_outcome, activity_topology
from mote.cli.consumers.textual.style import BRANCH, Palette
from mote.cli.consumers.textual.widgets.transcript import FoldableRow, build_tool_parts
