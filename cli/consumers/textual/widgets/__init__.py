...
every symbol here as a facade, so ``from metagpt.cli.consumers.textual.widgets
...
``metagpt.cli.consumers.render.builders`` so the terminal and Textual hosts never
...
from metagpt.cli.consumers.textual.widgets.prompt_input import PROMPT_SYMBOL, PromptInput
from metagpt.cli.consumers.textual.widgets.status_bar import StatusBar, _format_tok
from metagpt.cli.consumers.textual.widgets.transcript import (
    ApprovalMarkerRow,
    AssistantBlock,
