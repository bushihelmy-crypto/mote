"""Dependency-free parsing for model-facing tool docstrings.

Kernel is the lowest production consumer; higher layers reuse the same parser.
"""
...
def first_line(fn_or_doc: Union[Callable[..., Any], str, None]) -> str:
...
def description_body(fn_or_doc: Union[Callable[..., Any], str, None]) -> str:
