...
from mote.kernel.prompt.memory import MEMORY_CONTEXT, MEMORY_EMPTY_STATE, MEMORY_INSTRUCTIONS
from mote.kernel.prompt.refs import assert_no_symbols
from mote.kernel.prompt.role import (
    COMPACTION_SECTION,
    LANGUAGE_SECTION,
    SCRATCHPAD_SECTION,
