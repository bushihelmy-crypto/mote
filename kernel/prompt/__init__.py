"""Kernel prompt protocol, organized by category.
...
Names are re-exported here so callers can do ``from mote.kernel.prompt
import SYSTEM_PROMPT`` or import the submodule directly.
"""
from mote.kernel.prompt.agent import (
    AGENT_SECTION_TEMPLATE,
    AGENT_TASK_PROMPT,
    SUBAGENT_SECTION_TEMPLATE,
    SUBAGENT_TASK_PROMPT,
)
from mote.kernel.prompt.compaction import NO_TOOLS_PREAMBLE, NO_TOOLS_TRAILER
from mote.kernel.prompt.memory import (
    MEMORY_CONTEXT,
    MEMORY_EMPTY_STATE,
