...
#      XML built-in definitions are session prompt content; MCP definitions and
#      XML pipeline definitions ride the per-turn reminder so hot reload never
#      rewrites the stable system-prompt catalog.
