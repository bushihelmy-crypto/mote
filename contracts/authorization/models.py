...
class PermissionDecision:
    ...
    message: str = ""
    updated_args: Optional[dict[str, object]] = None
...
class PermissionFacts:
    ...
    the policy-rewritten arguments and hands them to the permission policy. This
    seam keeps the policy layer independent of concrete tools.
