"""Tool execution config and constants — consolidated from mote.runtime.tools/tool_result_limit.py.

The enforcement logic stays in ``mote.runtime.tools.tool_result_limit``; only the
...
from mote.contracts.constants.tool_output import PERSISTED_OUTPUT_CLOSE, PERSISTED_OUTPUT_OPEN
