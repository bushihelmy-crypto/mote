"""Durable file-domain facts for managed file transactions."""
...
from mote.contracts.file.identity import FileVersion, ProjectIdentity
...
class FileHistoryImportedEvent:
    ...
    def __post_init__(self) -> None:
        ...
        if self.before is not None and type(self.before) is not ContentIdentity:
