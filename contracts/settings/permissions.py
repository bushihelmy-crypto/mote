...
from mote.contracts.permissions import PermissionMode
...
class PermissionConfig(BaseModel):
    ...
    Matching semantics (see ``executor/permission/rule_matcher.py``):
      ...
      * Read/Edit/Search path targets are absolute, normalized against the
        Role working directory, and symlink-resolved before matching;
