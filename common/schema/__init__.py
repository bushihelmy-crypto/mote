...
_LAZY_MAPPING: dict[str, tuple[str, str]] = {
    # provider-independent model actions / completion decisions
    "TextAction": ("action", "TextAction"),
    "ToolCallAction": ("action", "ToolCallAction"),
    "FinalCandidateAction": ("action", "FinalCandidateAction"),
    "ModelTurn": ("action", "ModelTurn"),
    ...
    "SchemaDocument": ("output", "SchemaDocument"),
    "OutputBindingKind": ("output", "OutputBindingKind"),
    "OutputLifecycleState": ("output", "OutputLifecycleState"),
    "RunKind": ("output", "RunKind"),
    "OutputBinding": ("output", "OutputBinding"),
    "OutputBindingDecision": ("output", "OutputBindingDecision"),
    "OutputRepresentationCapabilities": (
        "output",
        "OutputRepresentationCapabilities",
    ),
    "ValidationStage": ("output", "ValidationStage"),
    "ValidatorEffect": ("output", "ValidatorEffect"),
    "Determinism": ("output", "Determinism"),
    "ValidationContext": ("output", "ValidationContext"),
    "ValidatorProvenance": ("output", "ValidatorProvenance"),
    "Accept": ("output", "Accept"),
    "Corrected": ("output", "Corrected"),
    "Reject": ("output", "Reject"),
    "RetryLater": ("output", "RetryLater"),
    "ValidationIssue": ("output", "ValidationIssue"),
    "OutputDecodeError": ("output", "OutputDecodeError"),
    "CorrectionFeedback": ("output", "CorrectionFeedback"),
    "OutputEvaluation": ("output", "OutputEvaluation"),
    "CommittedOutput": ("output", "CommittedOutput"),
    "TranscriptRef": ("output", "TranscriptRef"),
    "RunResult": ("output", "RunResult"),
    "RunLease": ("run_lease", "RunLease"),
    "RunLeasePolicy": ("run_lease", "RunLeasePolicy"),
    # messages
