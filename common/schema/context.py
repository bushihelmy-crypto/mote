...
from mote.common.const.context import MAX_CONSECUTIVE_AUTOCOMPACT_FAILURES as _MAX_CONSECUTIVE_AUTOCOMPACT_FAILURES
from mote.common.const.context import MAX_OUTPUT_TOKENS_FOR_SUMMARY as _MAX_OUTPUT_TOKENS_FOR_SUMMARY
