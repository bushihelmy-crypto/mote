...
class FileWatchService(ObservationSubscriber):
    ...
    async def start_async(self) -> None:
        """Async start: build the watcher's baseline cooperatively.

        Delegates to :meth:`FileWatcher.start_async`; its bounded batches yield
        during a large recursive walk so the UI remains responsive.
        """
