...
The gap it closes: :class:`~mote.executor.effect_ledger.EffectLedger` records the
...
:class:`~mote.common.ledger.AppendOnlyLedger` base.
"""
...
async def run_journaled_step(
    ...
    *,
    ...
    cause a double side effect, so both :class:`~mote.loop.durable.JsonlBackend`
