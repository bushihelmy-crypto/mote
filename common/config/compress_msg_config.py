...
class CompressType(Enum):
    ...
    - "balanced_cut_by_token": Keep as many latest messages as possible and balanced-truncate the earliest fit-in message.
    ...
    BALANCED_CUT_BY_TOKEN = "balanced_cut_by_token"
