...
It maps onto the framework-agnostic frozen :class:`~mote.common.resilience.config.BreakerConfig`
...
from mote.common.resilience.config import BreakerConfig
...
class ResilienceConfig(YamlModel):
    ...
    # also the lease after which a claimed-but-never-recorded probe is reclaimed.
