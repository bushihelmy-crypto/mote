"""The pure redaction function — mask known secret values in a string.
...
both the read-direction (PostToolUse output rewrite) and any future scanner
...
# (mote.common.config.secrets._PLACEHOLDER_KEYS) plus the redaction marker itself.
