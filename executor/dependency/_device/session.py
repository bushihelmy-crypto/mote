...
Mirrors :class:`mote.executor.dependency._browser.BrowserSession`'s lifecycle
...
from mote.executor.dependency._device.outline import Snapshot, build_snapshot, render_snapshot
