...
modules so the :class:`~mote.executor.tools.apply_patch.ApplyPatch` tool can
...
from mote.executor.dependency._apply_patch.applier import affected_paths, apply_update
