...
commit: :class:`~mote.orchestration.agents.identity.registry.SpawnReservation`,
:class:`~mote.orchestration.agents.residency.manager.ResidencySlot`, and
:class:`~mote.orchestration.agents.execution.limiter.AgentExecutionGuard`. They differ only in
