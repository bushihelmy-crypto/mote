...
from mote.runtime.logging import get_human_input
from mote.runtime.tools.permission.prompts import parse_approval_response, render_approval_prompt
...
class MoteEnv(AgentEnvironment):
    ...
    async def request_approval(self, request: Any, sent_from: Optional[Any] = None) -> str:
        ...
        an :data:`~mote.contracts.permissions.ApprovalChoice`. The rich
