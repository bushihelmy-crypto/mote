#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""mote.orchestration.environment.scheduling — cron / scheduled-task subsystem.
...
from mote.orchestration.environment.scheduling.cron import compute_next_cron_run, cron_to_human, parse_cron_expression
from mote.orchestration.environment.scheduling.lock import SchedulerLock
from mote.orchestration.environment.scheduling.scheduler import CronScheduler
