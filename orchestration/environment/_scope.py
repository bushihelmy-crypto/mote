...
commit: :class:`~mote.orchestration.environment.registry.SpawnReservation`,
:class:`~mote.orchestration.environment.residency.ResidencySlot`, and
:class:`~mote.orchestration.environment.limiter.AgentExecutionGuard`. They differ only in
