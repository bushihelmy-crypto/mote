"""BaseNode — abstract base class for WorkflowBuilder nodes.
...
class BaseNode(ABC):
    """WorkflowBuilder node base class.
    ...
    def get_json_schema(cls) -> Mapping[str, JsonValue]:
        ...
        Reuses :func:`~mote.kernel.tools.spec_adapter.annotation_to_json_schema`
