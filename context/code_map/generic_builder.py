...
neutral :class:`~mote.context.code_map.scopes.ScopeGraph` + presentation symbols.

This is the tree-sitter twin of the Python ``ast`` walk
(:class:`~mote.context.code_map.providers.python._ScopeGraphBuilder`): given a
:class:`~mote.context.code_map.providers.config.LangConfig` (pure data — which
...
from mote.context.code_map.model import SUMMARY_MAX_CHARS, Symbol
from mote.context.code_map.providers.config import DefRule, DocRule, LangConfig
