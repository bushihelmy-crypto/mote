...
:class:`~mote.context.code_map.model` rows + a resolved
:class:`~mote.context.code_map.scopes.ScopeGraph`, and one :class:`ModuleResolver`
...
from mote.context.code_map.model import ImportBinding, ImportRef, Symbol
...
class ProviderExtract:
    ...
    The facade wraps this into a :class:`~mote.context.code_map.model.FileExtract`,
