...
imports and answer module⇄file questions. :class:`~mote.context.code_map.generic_builder.TreeSitterBuilder`
reads exactly this to emit the same neutral
:class:`~mote.context.code_map.scopes.ScopeGraph` + :class:`~mote.context.code_map.model.Symbol`
...
class DefRule:
    ...
    ``def_kind`` is the neutral :class:`~mote.context.code_map.scopes.Def` kind
