...
that emits a :class:`~mote.context.code_map.scopes.ScopeGraph` + presentation
...
from mote.context.code_map.model import SUMMARY_MAX_CHARS, ImportBinding, ImportRef, Symbol
