"""Provider assembly — the one place the set of live language providers is built.

:func:`all_providers` returns every :class:`~mote.context.code_map.providers.base.LanguageProvider`
...
native grammars degrades cleanly to Python-only. :mod:`mote.context.code_map.languages`
...
from mote.context.code_map._langconfigs import all_configs
from mote.context.code_map.providers.base import LanguageProvider, ModuleResolver, ProviderExtract
from mote.context.code_map.providers.python import PythonProvider
from mote.context.code_map.providers.tree_sitter import TreeSitterProvider
...
__all__ = ["all_providers", "LanguageProvider", "ModuleResolver", "ProviderExtract", "PythonProvider"]
