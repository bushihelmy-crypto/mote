...
through: which :class:`~mote.context.code_map.providers.base.LanguageProvider`
(if any) owns a given file, and the full set of extensions worth walking. The
registry is built once from :func:`~mote.context.code_map.providers.all_providers`
...
from mote.context.code_map.providers import all_providers
from mote.context.code_map.providers.base import LanguageProvider
