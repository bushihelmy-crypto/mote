...
class OutputEngine:
    def __init__(
        ...
        self.committed_output: CommittedOutput | None = None
    ...
    async def evaluate(self, candidate) -> OutputEvaluation:
        if self.accepted:
    ...
    async def commit(self) -> CommittedOutput:
        ...
        contract_id = str(self.contract.contract_id)
        encoded = self.contract.decoder.encode(self.accepted_value)
